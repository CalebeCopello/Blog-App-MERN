...
function PostCard({ post }) {
	return (
		<div className='group relative w-full bg-bg0_h_lm dark:bg-bg0_h_dm border border-orange1_lm dark:border-orange1_dm hover:border-2 h-[400px] overflow-hidden rounded-lg sm:w-[430px] transition-all shadow-md'>
			...
			<div className='p-3 flex flex-col gap-2'>
				...
				<span className='italic text-sm border-2 border-orange0 w-fit mx-auto rounded-xl px-2'>{post.category}</span>
				<Link
					to={`/post/${post.slug}`}
